...
abstract class AuthRemoteDataSource {
  ...
  Future<Result<bool>> register(String email, String password, String firstName, String lastName);
...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  @override
  Future<Result<TokenResponseModel>> login(String email, String password) async {
    // Input validation
  ...
  @override
  Future<Result<bool>> register(String email, String password, String firstName, String lastName) async {
    // Input validation
